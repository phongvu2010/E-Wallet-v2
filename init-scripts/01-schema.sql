...
CREATE TABLE loans (
    ...
    current_interest_rate DECIMAL(10, 6) NOT NULL CONSTRAINT chk_loan_rate CHECK (current_interest_rate >= 0),
    base_rate DECIMAL(10, 6) DEFAULT 0.00,
    floating_margin DECIMAL(10, 6) DEFAULT 0.00,
...
CREATE TABLE loan_schedules (
    ...
    due_date DATE NOT NULL,
    applied_interest_rate DECIMAL(10, 6) NOT NULL,
