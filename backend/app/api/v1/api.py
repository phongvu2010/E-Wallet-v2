...
api_router.include_router(accounts.router, prefix="/accounts", tags=["Accounts & Cards"])
api_router.include_router(categories.router, prefix="/categories", tags=["Categories"])
api_router.include_router(merchants.router, prefix="/merchants", tags=["Merchants & Aliases"])
api_router.include_router(statements.router, prefix="/statements", tags=["Statements & Reconciliation"])
api_router.include_router(transactions.router, prefix="/transactions", tags=["Transactions & Ledger"])
api_router.include_router(installments.router, prefix="/installments", tags=["Installment Plans & Forecast"])
