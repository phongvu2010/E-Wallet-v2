...
class Settings(BaseSettings):
    ...
    # Database Connection Pooling (Calibrated for Gunicorn Multi-Workers)
    # Total connections = WORKERS * (DB_POOL_SIZE + DB_MAX_OVERFLOW) + Background lock connections.
    # With WORKERS=4: 4 * (5 + 5) = max 40 connections, safely under typical 60-100 limits.
    DB_POOL_SIZE: int = 5
    ...
    TELEGRAM_WEBHOOK_SECRET: Union[str, None] = None
